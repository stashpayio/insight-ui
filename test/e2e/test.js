...
describe('basic UI tests', () => {
  ...
  beforeAll(async () => {
    ...
    const insightUIContainerOptions = {
      volumes: [
        `${rootPath}/stashcore-node:/insight/node_modules/@stashcore/insight-ui/stashcore-node`,
        `${rootPath}/po:/insight/node_modules/@stashcore/insight-ui/po`,
        `${rootPath}/public:/insight/node_modules/@stashcore/insight-ui/public`,
      ],
    };
    ...
    await masterNode.stashCore.getApi().generate(15);
  });
  ...
  describe('Home Page', () => {
    ...
    it('should be able search by block number', async () => {
      ...
      expect(blockReward).equal('500 STASH');
